...
var InputRange = (_class = function (_React$Component) {
  ...
  _createClass(InputRange, null, [{
    ...
    get: function get() {
      return {
        ...
        setTrackLengths: _propTypes2.default.bool,
        setTrackValueEnd: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
  ...
  _createClass(InputRange, [{
    ...
    key: 'getPercentages',
    value: function getPercentages(values) {
      var _props = this.props,
          setTrackLengths = _props.setTrackLengths,
          setTrackValueEnd = _props.setTrackValueEnd,
    ...
    value: function renderSliders() {
      ...
      return keys.map(function (key) {
        ...
        var classNames = _extends({}, _defaultClassNames2.default, _this3.props.classNames);
    ...
    value: function render() {
      ...
      var classNames = _extends({}, _defaultClassNames2.default, this.props.classNames);
      var componentClassName = classNames.inputRange;
      var values = valueTransformer.getValueFromProps(this.props, this.isMultiValue());
      var percentages = this.getPercentages(values);
...
var Track = (_class = function (_React$Component) {
  ...
  _createClass(Track, null, [{
    ...
    get: function get() {
      return {
        ...
        percentages: _propTypes2.default.objectOf(_propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number])).isRequired,
        styles: _propTypes2.default.objectOf(_propTypes2.default.shape({}))
      };
    }
  ...
  _createClass(Track, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        markerWidths: this.markerRefs.map(function (ref) {
    ...
    value: function render() {
      ...
      var activeTrackLength = this.getActiveTrackStyle();

      var _props$styles = this.props.styles,
          trackStyle = _props$styles.track,
          activeTrack = _props$styles.active;
      var markerWidths = this.state.markerWidths;


      var activeTrackStyle = _extends({}, activeTrack, activeTrackLength);
      ...
      return _react2.default.createElement(
        ...
        markers && markers.map(function (marker, idx) {
          var left = marker.percentage * 100;
          if (markerWidths.length) {
            left = 'calc(' + marker.percentage * 100 + '% - ' + Math.round(markerWidths[idx] / 2) + 'px)';
          }
          return _react2.default.createElement(
            'span',
            {
              key: marker.percentage,
              ref: function ref(markerSpan) {
                return _this2.markerRefs.push(markerSpan);
              },
              className: marker.class,
              id: marker.id,
              onClick: function onClick() {
                return marker.onClick(marker);
              },
              style: {
                position: 'absolute',
                left: left,
